                ...
                <form className="mt-8 space-y-5" onSubmit={handleCallSubmit}>
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                      <div>
                        ...
                        <input
                          ...
                          className="h-[54px] w-full rounded-lg border border-[#dbe1ea] bg-white px-4 text-[14px] text-[#1b2943] outline-none transition focus:border-[#0d4c8f] appearance-none"
                        />
                      </div>
                  ...
                  <div className="pt-1">
                    <button
                      ...
                      className="rounded-md bg-[#0d4c8f] px-6 py-3 text-[13px] font-semibold text-white shadow-sm transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      {submitState.loading ? "Submitting..." : "Schedule Call"}
                    </button>
                  </div>
                </form>
              )}
